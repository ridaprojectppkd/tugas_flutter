...
import 'package:tugas_flutter/tugas11/modelang.dart'; // Import the edit screen

class Tugas12c extends StatefulWidget {
  const Tugas12c({super.key});

  @override
  State<Tugas12c> createState() => _Tugas12cState();
}

class _Tugas12cState extends State<Tugas12c> {
