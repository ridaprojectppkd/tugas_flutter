...
class ProfilePage13 extends StatelessWidget {
  const ProfilePage13({super.key});
              ...
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    border: Border.all(
                      color: Color.fromARGB(255, 97, 1, 223),
                      width: 3,
                    ),
                  ),
                ),
                const CircleAvatar(
                  radius: 70,
                  backgroundImage: AssetImage('Assets/image/animmol.jpg'),
                ...
                Positioned(
                  ...
                  child: Container(
                    decoration: BoxDecoration(
                      color: Color.fromARGB(255, 54, 15, 199),
                      shape: BoxShape.circle,
                      border: Border.all(
                        color: Colors.white,
                        width: 2,
