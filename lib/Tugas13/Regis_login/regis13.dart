...
import 'package:tugas_flutter/meet_16/user_model.dart';

class RegisterScTigas extends StatefulWidget {
  const RegisterScTigas({super.key});
  static const String id = "/register_screen_app";
  @override
  State<RegisterScTigas> createState() => _RegisterScTigasState();
}

class _RegisterScTigasState extends State<RegisterScTigas> {
